...
if __name__  == '__main__':
    ...
    regions =  [np.array([1, 2, 4, 5, 3, 8, 7, 9, 6, 15, 16, 17,11, 12, 13, 29, 20, 19, 10, 22, 23, 32]),
                np.array([18, 32, 14, 30, 31, 21, 26, 25, 27, 24, 33, 35, 36, 28, 39, 38, 37]),
                np.array([43, 40, 41, 45, 44, 42, 46])]
